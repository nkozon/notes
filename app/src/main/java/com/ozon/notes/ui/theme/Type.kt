...
fun getTypography(appFont: AppFont = AppFont.DEFAULT): Typography {
    val (titleFamily, bodyFamily) = when (appFont) {
        AppFont.DEFAULT -> Pair(GoogleSansFlexRounded, GoogleSansFlex)
        AppFont.SYSTEM -> Pair(FontFamily.Default, FontFamily.Default)
    }
...
val Typography = getTypography(AppFont.DEFAULT)
